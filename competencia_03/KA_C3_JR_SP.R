...
PARAM$finalmodel$num_iterations <- 17
PARAM$finalmodel$learning_rate <- 0.729
PARAM$finalmodel$feature_fraction <- 0.1729
PARAM$finalmodel$min_data_in_leaf <- 1729
PARAM$finalmodel$num_leaves <- 1729
...
#############FE intra mes####################################
#única varaible creada que dejo
