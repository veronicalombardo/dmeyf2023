...
PARAM$experimento <- "KA_C3_SEM_LR1_SP" 
...
PARAM$finalmodel$num_iterations <- 20
PARAM$finalmodel$learning_rate <- 1
PARAM$finalmodel$feature_fraction <- 0.4
PARAM$finalmodel$min_data_in_leaf <- 5000
PARAM$finalmodel$num_leaves <- 40
