...
PARAM$experimento <- "BO_C3_2_goss_0504_SP"

PARAM$input$dataset <- "./datasets/competencia_03_V2.csv.gz"

# los meses en los que vamos a entrenar
# elimino de Marzo a Septiembre de 2020
# Valido en 202106 y testeo en 202107 por si afecta aguinaldo y vacaciones de invierno
...
#############FE intra mes####################################
#elimino las variables creadas salvo la inv_ctrx_quarter
